...
if __name__=="__main__":
   ...
   if args.pfile == None:
      ...
      if args.outfile == 'pk':
         s = args.pfile
         fmtpos = s.rfind('.')
         outfile = s[:fmtpos] + '_cleftpk2_z%03d'%(args.z*100) + s[fmtpos:]
      ...
      print ('GRpl sl, sloop, sloop/snl = ', (1./3)*cl.xi00lin, (1./3)*cl.xi00loop, cl.xi00loop/cl.xi00lin)
      ##Save them
      zeroQ=np.zeros_like(cl.qf.Q1)
      zeroR=np.zeros_like(cl.qf.R1)
      if args.saveq:
         #header = 'k[h/Mpc]   Q1   Q2    Q3    Q5    Q8    Qs2   Q7   Q9   Q11   Q12   Q13  \n'
         #np.savetxt(qfile, np.array([cl.qf.kq, cl.qf.Q1, cl.qf.Q2, cl.qf.Q3, cl.qf.Q5, cl.qf.Q8, cl.qf.Qs2, cl.qf.Q7, cl.qf.Q9, cl.qf.Q11, cl.qf.Q12, cl.qf.Q13]).T, fmt='%0.4e')
         #np.savetxt(qfile, np.array([cl.qf.kq, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ, zeroQ]).T, fmt='%0.4e')
      ...
      if args.saver:
         ...
         #np.savetxt(rfile, np.array([cl.qf.kr, zeroR, zeroR]).T, fmt='%0.4e')
         #np.savetxt(rfile, np.array([cl.qf.kr, cl.qf.R1, cl.qf.R2]).T, fmt='%0.4e', header=header)
      #print (cl.qf.kr, (cl.qf.R1+cl.qf.R2)/cl.qf.R3, cl.qf.R1/cl.qf.R4)
      #Calculate spectrum
