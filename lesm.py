...
Aperp=0
x=LSM(32)
x('plin_testk2.txt',ff,b1,b2,bs,Aeft,Aeft1,s2FoG,Apar,Aperp)
#print (x(pkfile,ff,b1,b2,bs,Aeft,Aeft1,s2FoG,Apar,Aperp))
#print (x('plin_testk2.txt',1,1,0.1,0,0,0,0,0,0))
#self.__call__(self,'plin_testk2.txt',1,1,0.1,0,0,0,0,0,0)
